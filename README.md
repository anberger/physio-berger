...
- **E-Mail-Adresse:** `monia@physioberger.at`
- **Domain:** `physioberger.at`
...
2. **GitHub Pages aktivieren (falls nicht automatisch aktiv):**
   ...
   - Die CNAME-Datei mit `physioberger.at` ist bereits im Projekt hinterlegt.

3. **Eigene Domain verknüpfen (`physioberger.at`):**
   - Unter **Settings** → **Pages** → **Custom domain** ist `physioberger.at` hinterlegt; aktiviere dort *Enforce HTTPS*.
